		...
		<div className="flex flex-row">
			...
			<div className="w-full text-white p-5">
              ...
              className="bg-primary rounded-lg p-6 h-fit my-5"
						>
							<h2 className="text-xl font-semibold py-4">Doctor's Notes</h2>
							<p>
							...
							<p>
								<strong>Reason for Visit:</strong> Routine
							...
							<p>
								<strong>Chief Complaint:</strong> No new
								complaints, here for routine follow-up.
							</p>
							<p>
								<strong>
							...
							<ul>
								...
								<li>
									Denies chest pain, palpitations, shortness
							...
							<ul>
								<li>
									<strong>Cardiovascular:</strong> No chest
									pain or palpitations.
								</li>
								<li>
									<strong>Respiratory:</strong> No shortness
									of breath or cough.
								</li>
								<li>
							...
							<ul>
								<li>
									<strong>General:</strong> Alert, oriented,
									in no acute distress.
								</li>
								<li>
									<strong>Cardiovascular:</strong> Normal
									heart sounds, no murmurs or gallops.
								</li>
								<li>
								...
								<li>
									<strong>Abdomen:</strong> Soft, non-tender,
									no masses.
								</li>
								<li>
									<strong>Extremities:</strong> No edema,
							...
							<ul>
								<li>
									<strong>Hypertension:</strong> Stable on
									current regimen, no evidence of
									complications.
								</li>
								<li>
							...
							<ul>
								<li>
									Continue Lisinopril 10mg daily for
									hypertension.
								</li>
								<li>
								...
								<li>
									Follow-up in 3 months for reassessment of
									blood pressure control.
								</li>
								<li>
									PRN acetaminophen for headaches as needed.
								</li>
							</ul>
							...
							<p>
								<strong>Doctor's Signature:</strong> Dr. Jane
								Smith
							</p>
							<p>
