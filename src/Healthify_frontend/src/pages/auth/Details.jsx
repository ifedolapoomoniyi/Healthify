...
const Details = () => {
	...
	return (
		<div className="flex flex-row gap-5 text-white min-h-screen items-center bg-healthImage bg-cover">
			<div className="text-white p-5 max-w-[700px] md:p-10 bg-transparentBlack h-full">
